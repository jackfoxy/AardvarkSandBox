...
let project = "AardvarkSandBox"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Aardvark SandBox"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Aardvark SandBox"

// List of author names (for NuGet package)
let author = "Jack Fox"

// Tags for your project (for NuGet package)
let tags = "F# 3d graphics visualization"

// File system information
let solutionFile  = "AardvarkSandBox.sln"
...
let projectsToBuild =
    [|
        Path.getFullName "./src/Utils"
        Path.getFullName "./src/Server"
        Path.getFullName "./src/AdaptiveWorld"
        Path.getFullName "./src/BackgroundColor"
        Path.getFullName "./src/Gravity"
